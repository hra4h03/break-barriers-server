...
export const SignIn = () => {
  ...
  return <div className="bg-gray-600">
    ...
    <div className="my-2 md:my-0">
      <img className="w-full h-full object-contain" src="/assets/app.png" alt="Application" />
      <Dash />
    </div>
    <div>
      <h1 className="text-5xl text-gray-300 mb-8 font-sans font-semibold">Break Barriers</h1>
      <div className="border shadow-sm py-3 my-1 rounded-md flex justify-center items-center bg-yellow-100">
        ...
        <span className="font-semibold font-sans text-green-700">Get more by using this app!!</span>
      </div>
      <Dash />
      ...
      <% } %> */}
      <form id="form" className="flex flex-col w-full" action="/users/create/" method="POST">
        <Input 
        ...
        <div className="flex justify-between items-center">
          <button 
            ...
            type="submit" 
          >Send</button>
          <span className="text-gray-300">Already have an account? <a href="/login/" className="underline text-blue-300">Login here</a>.</span>
        </div>
      </form>
    </div>      
  </div>
